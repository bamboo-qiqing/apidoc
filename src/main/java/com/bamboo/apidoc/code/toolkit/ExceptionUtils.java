...
public class ExceptionUtils {
   ...
   * @return 返回异常
   */
  public static ApiDocException mpe(String msg, Throwable t, Object... params) {
   ...
   * @return 返回异常
   */
  public static ApiDocException mpe(String msg, Object... params) {
   ...
   * @return 返回异常
   */
  public static ApiDocException mpe(Throwable t) {
